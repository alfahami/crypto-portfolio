...
public class ExchangeRateEndToEndApiTest {
    ...
    /*
     * Validate that the endpoint /exchange-rate?symbol=BTC&base=MAD is responding
     * correctly with the correct HTTP status, content type, and expected JSON
     * structure.
     */
    @Test
    ...
    /*
     * Validate that the endpoint /exchange-rate/latest is responding correctly with
     * the correct HTTP status, content type, and expected JSON structure.
     */
    @Test
    ...
    /*
     * Validate that the endpoint /exchange-rate?symbol=XXXX&base=YYYY with error
     * code.
     */
    @Test
